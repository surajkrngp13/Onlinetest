...
let all = document.querySelectorAll('.question-card')
  console.log("Total cards:", all.length)

  let match = document.querySelectorAll('.' + className)
...
function renderAllQuestions() {
    ...
    function renderChunk() {
        ...
        for (let c = 0; c < chunkSize && gIndex < total; c++, gIndex++) {
            ...
            html += `
                <div class="question-card ${safeClass} ${answeredClass}" id="question_${i}" data-qindex="${i}">
                    <div class="question-header">
                        <div class="qno">Question ${i + 1} of ${total}</div>
...
function showResults() {
    ...
    modal.innerHTML = `
        <div class="results-card">
            ...
            <div class="result-score">Score: ${correct}/${totalQuestions2}</div>
            ...
            <details style="margin-top:20px"><summary style="cursor:pointer;font-weight:600;color:#e67e22;">📋 Detailed Answers</summary><div style="max-height:400px;overflow-y:auto;margin-top:12px;" id="detailedAnswers">${details}</div></details>
